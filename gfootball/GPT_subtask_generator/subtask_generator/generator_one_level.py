...
def main(model, n_decomposition, n_reward, temperature, task, alg_cfg, use_doe, n_improve_iter):
    ...
    reward_signature = file_to_string(f'{prompt_dir}/reward_signature')
    ...
    for response_id in range(n_decomposition):
        ...
        train_merge_team(groups, use_doe, layer=0, decompose_id=response_id, buffer_dir=f'{FOOTBALL_MEDoE_DIR}/doe_epymarl-main/results/buffers/gfootball/{Time}', max_reward_code_path_for_each_group=max_reward_code_path_for_each_group, Time=Time)
