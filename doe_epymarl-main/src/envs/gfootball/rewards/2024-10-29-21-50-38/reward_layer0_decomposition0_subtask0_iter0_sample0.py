class CheckpointRewardWrapper(gym.RewardWrapper):
  ...
  def reward(self, reward):
    ...
    for rew_index in range(len(reward)):
      ...
      active_player_has_ball = ('ball_owned_team' in o
                                and o['ball_owned_team'] == 0
                                and 'ball_owned_player' in o
                                and o['ball_owned_player'] == o['active'])

      if not active_player_has_ball:
        continue

      distance_to_goal = ((o['ball'][0] - 1) ** 2 + o['ball'][1] ** 2) ** 0.5
